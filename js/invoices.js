            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="table-actions">
                        <a href="../payments/" class="btn btn-sm btn-outline"> ${icon('payments', '18', 'icon-svg')} Pay</a>
                        <a href="../patient-profile/?id=${inv.patientId || ""}" class="btn btn-sm btn-outline"> ${icon('eye', '18', 'icon-svg')} Profile</a>
