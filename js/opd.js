            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="table-actions">
                        ...
                        <a href="../consultation/?visitId=${apt.id}" class="btn btn-sm btn-outline"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> Consult</a>
                    </div>
                </td>
            </tr>
        `;
