            ...
            <tr>
                <td>
                    <div class="table-user-cell">
                        ...
                        <div>
                            <a href="../patient-profile/?id=${patient.id}" class="table-link"><strong>${escapeHtml(fullName)}</strong></a>
                ...
                <td class="text-right">
                    <div class="table-actions">
                        <a href="../patient-profile/?id=${patient.id}" class="btn btn-sm btn-outline" data-permission="PATIENT_READ">${icon('eye')} View</a>
...
window.editPatient = async function(patientId) {
    ...
    window.location.href = `../patient-profile/?id=${patientId}&edit=true`;
}
