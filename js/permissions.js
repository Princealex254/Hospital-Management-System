...
export function hasAreaAccess(area) {
    if (!currentUser || !area || hasFullAccessRole(currentUser.role)) return true;
    if (!Array.isArray(currentUser.accessAreas)) return true;
    return currentUser.accessAreas.includes(area);
}
